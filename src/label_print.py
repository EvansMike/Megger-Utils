...
specs = labels.Specification(131, 196, 3, 7, 38, 25, corner_radius=2)


def draw_label(label, width, height, obj):
    # Just convert the object to a string and print this at the bottom left of
    # the label.
    label.add(shapes.String(5, 25,  str(obj[0]), fontName="Helvetica", fontSize=8))
    label.add(shapes.String(80, 25, str(obj[1]), fontName="Helvetica", fontSize=8))
    label.add(shapes.String(5, 2,   str(obj[2]), fontName="Helvetica", fontSize=8))
    label.add(shapes.String(55, 2,  str(obj[3]), fontName="Helvetica", fontSize=8))
